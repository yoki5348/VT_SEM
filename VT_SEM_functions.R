perform_SEM_model0=function(dat,NTmlabel,Tmlabel,NTplabel,Tplabel,Yolabel){
...
perform_SEM_model1_eq=function(dat,NTmlabel,Tmlabel,NTplabel,Tplabel,Yolabel){
  nv=1 #Number of variants
  dat_SEM <- dat[,c(NTmlabel,Tmlabel,NTplabel,Tplabel,Yolabel)]
  colnames(dat_SEM)=c("NTm","Tm","NTp","Tp","Yo")
...
perform_SEM_model1_dis=function(dat,NTmlabel,Tmlabel,NTplabel,Tplabel,Yolabel){
  nv=1 #Number of variants
  dat_SEM <- dat[,c(NTmlabel,Tmlabel,NTplabel,Tplabel,Yolabel)]
  colnames(dat_SEM)=c("NTm","Tm","NTp","Tp","Yo")
...
perform_SEM_model2_eq=function(dat,NTmlabel,Tmlabel,NTplabel,Tplabel,Ymlabel,Yplabel,Yolabel){
  nv=1 #Number of variants
...
perform_SEM_model2_dis=function(dat,NTmlabel,Tmlabel,NTplabel,Tplabel,Ymlabel,Yplabel,Yolabel){
  nv=1 #Number of variants
  dat_SEM <- dat[,c(NTmlabel,Tmlabel,NTplabel,Tplabel,Ymlabel,Yplabel,Yolabel)]
  colnames(dat_SEM) <- c("NTm","Tm","NTp","Tp","Ym","Yp","Yo")
...
perform_SEM_model2_eq_NP=function(dat,NTmlabel,Tmlabel,NTplabel,Tplabel,Yolabel,herit0,prop.latent){
  nv=1 #Number of variants
  dat_SEM <- dat[,c(NTmlabel,Tmlabel,NTplabel,Tplabel,Yolabel)]
  colnames(dat_SEM) <- c("NTm","Tm","NTp","Tp","Yo")
...
perform_SEM_model2_dis_NP=function(dat,NTmlabel,Tmlabel,NTplabel,Tplabel,Yolabel,herit0,prop.latent){
  nv=1 #Number of variants
  dat_SEM <- dat[,c(NTmlabel,Tmlabel,NTplabel,Tplabel,Yolabel)]
  colnames(dat_SEM) <- c("NTm","Tm","NTp","Tp","Yo")
